...
namespace Server
{
    class LeagueSocketBehavior : WebSocketSharp.Server.WebSocketBehavior
    {
        ...
        private void HandleWebSocketMessage(object sender, MessageEventArgs args)
        {
            ...
            Logger.Log(uri);
            //Program.mainForm.dispatcher.Invoke(new Action(() => { Program.mainForm.addCall(uri); }));
        ...
        protected override void OnMessage(MessageEventArgs e)
        {
            ...
            {
                Send("[3, \"" + "1.0" + "\", \"" + Environment.MachineName + "\"]");
            }
        }
